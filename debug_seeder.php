...
try {
    ...
    echo "4. Discount Categories Added\n";
    ...
    echo "7. Purchase Orders Added\n";

    DB::commit();
    echo "SUCCESS: SYSTEM SEEDED WITH SAMPLE DATA!\n";
